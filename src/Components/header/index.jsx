    ...
    <>
      <nav className="flex justify-between items-center w-full z-20 fixed top-0 left-0 h-14 bg-gradient-to-r from-orange-200 via-[#f49d3f] to-[#f49d3f] px-4">
        ...
        <div
          ...
          } absolute lg:relative top-14 lg:top-0 left-0 w-full lg:w-auto bg-gradient-to-r from-orange-200 via-[#f49d3f] to-[#f49d3f] lg:bg-transparent px-4 lg:px-0`}
        >
          {userLoggedIn ? (
            <div className="flex flex-col lg:flex-row items-start lg:items-center w-full lg:w-auto">
              ...
              <button
                ...
                className="text-lg text-white transition ease-in-out px-4 py-2 rounded-lg duration-1000 hover:text-xl cursor-pointer relative w-full lg:w-auto"
              >
                <img
              ...
              <div className="relative w-full lg:w-auto">
                <button
                  className="text-lg text-white transition ease-in-out px-4 py-2 rounded-lg duration-1000 hover:text-xl cursor-pointer w-full lg:w-auto"
